...
sum_feature_sets('genmix', 'tok mixtokpos mixtokawc')
sum_feature_sets('genallmix', 'tok pos awc mixtokpos mixtokawc')

sum_feature_sets('tok+src', 'tok src')
sum_feature_sets('genpos+src', 'tok pos src')
sum_feature_sets('genawc+src', 'tok awc src')
sum_feature_sets('genposmix+src', 'tok pos mixtokpos src')
sum_feature_sets('genawcmix+src', 'tok awc mixtokawc src')
sum_feature_sets('genall+src', 'tok pos awc src')
sum_feature_sets('genmix+src', 'mixtokpos mixtokawc src')
sum_feature_sets('genallmix+src', 'tok pos awc mixtokpos mixtokawc src')
sum_feature_sets('genmixp+src', 'tok mixtokpos src')
sum_feature_sets('genmixa+src', 'tok mixtokawc src')
